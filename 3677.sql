...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 05, 2021 at 12:25 PM
...
(8, 96, 1, 'hello world!', 3, '2021-01-14 05:29:33', '2021-01-14 05:29:33');
...
(5, NULL, 'Laravel Personal Access Client', 'Laals5vO8d1Yrdk3B46FO2YhsQmP3WAo2PgjHnB9', NULL, 'http://localhost', 1, 0, 0, '2021-01-14 03:24:17', '2021-01-14 03:24:17'),
(6, NULL, 'Laravel Password Grant Client', '1HcTQT0OwQOwKv1s62CRgw7wlVJM3chL27rdGmV6', 'users', 'http://localhost', 0, 1, 0, '2021-01-14 03:24:17', '2021-01-14 03:24:17');
...
(3, 5, '2021-01-14 03:24:17', '2021-01-14 03:24:17');
...
INSERT INTO `posts` (`id`, `user_id`, `status`, `title`, `slug`, `description`, `photo`, `image`, `audio`, `video`, `created_at`, `updated_at`) VALUES
(2, 1, 1, 'Hi', 'hello', 'hhhhh', 'kkkk', '', '', '', '2021-01-04 07:00:27', '2021-02-05 03:42:23'),
(3, 1, 1, 'Hello', 'hello-1', '5623', 'kkkk', '', '', '', '2021-01-05 04:11:17', '2021-01-05 04:11:17'),
(4, 1, 1, 'Hi', 'hi', 'Hello world!!', NULL, NULL, NULL, NULL, '2021-02-05 03:26:38', '2021-02-05 03:26:38'),
(5, 1, 1, 'hhh', 'hhh', 'hhhhhhh', NULL, NULL, NULL, NULL, '2021-02-05 07:18:09', '2021-02-05 07:18:09'),
(6, 1, 1, 'hhh', 'hhh-1', 'hhhhhhh', NULL, NULL, NULL, NULL, '2021-02-05 07:19:11', '2021-02-05 07:19:11');
...
CREATE TABLE IF NOT EXISTS `post_likes` (
  ...
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `post_id` bigint(20) UNSIGNED NOT NULL,
  `isLike` enum('true','false') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'false',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `interested_category` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `users` (`id`, `name`, `surname`, `nickname`, `email`, `email_verified_at`, `password`, `interested_category`, `two_factor_secret`, `two_factor_recovery_codes`, `remember_token`, `created_at`, `updated_at`, `last_login`) VALUES
...
(7, 'Aram', 'Mirzoyan', NULL, 'mirzoyanaram98@gmail.com', NULL, '$2y$10$bgpGjclStjA8nN..APs71ea.s2nX.oq8p0jI6igtzi6FlTG5KtXXq', '', NULL, NULL, NULL, '2021-02-05 05:08:27', '2021-02-05 05:08:27', NULL),
(8, 'Vrdo', 'vardanyan', 'UUUUUUU', 'hhhhkjhhhhhhh@gmail.com', NULL, '$2y$10$wrxGakbeC.3XIgz.YwDgseWQodJUmvbDkkHFUXXo74um6r4XgtZIW', 'design525', NULL, NULL, NULL, '2021-02-05 05:09:58', '2021-02-05 08:01:04', NULL);
